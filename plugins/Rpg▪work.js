...
"Ayudas a moderar el grupo de 𝗦𝗵𝗶𝗻𝗮 por", "Diseñaste un logo para *𝗦𝗵𝗶𝗻𝗮* por", 
"Moderaste el grupo cuando *𝗦𝗵𝗶𝗻𝗮* no estaba, el pago fue", 
"¡Trabajó lo mejor que pudo en una imprenta que estaba contratando y ganó su bien merecido!", 
"Trabajas como podador de arbustos para *𝗦𝗵𝗶𝗻𝗮* y ganas", "La demanda de juegos para dispositivos móviles ha aumentado, por lo que creas un nuevo juego lleno de micro-transacciones. Con tu nuevo juego ganas un total de", 
"Trabajas como actor de voz para Bob Esponja y te las arreglaste para ganar", 
"Estabas cultivando y Ganaste", "Trabajas como constructor de castillos de arena y ganas", "Trabajaste y Ganaste", 
"Trabajas como artista callejer@ y ganas","¡Hiciste trabajo social por una buena causa! por tu buena causa Recibiste", 
