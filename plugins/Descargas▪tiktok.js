...
if (!text) throw `*_⚠️ te faltó el link de tiktok prro._*`
...
conn.sendButton(m.chat, `*_Aqui tiene su video 𝗦𝗵𝗶𝗻𝗮_*`, ``, data[data.length - 1], [['「AUDIO🔊」', `.tomp3`]], m, { contextInfo: { externalAdReply: { showAdAttribution: false, title: '🌿 TikTok Downloader', body: me, sourceUrl: global.script, thumbnail: fs.readFileSync('./storage/image/tiktoklogo.jpg') }}})}
