...
let name = await conn.getName(m.sender)
  ...
  await conn.sendButton(m.chat, text.trim(), `*${saludo}*`, imgmenu, [['Iɴғᴏ📌', '.infobot'], ['Cʀᴇᴀᴅᴏʀ🐢', '.owner']], false, { quoted: m, contextInfo: { mentions: [who], externalAdReply: { showAdAttribution: true, mediaType: 'VIDEO', mediaUrl: '', title: '꧁𝗦𝗵𝗶𝗻𝗮⚔𝐵𝑂𝑇࿐', body: ignyc, thumbnail: miniurl, sourceUrl: global.linkgc }}})
  } catch (e) {
