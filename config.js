...
global.owner = [
  ['51936448126', '𝗦𝗵𝗶𝗻𝗮 (ᴄʀᴇᴀᴅᴏʀ)', true],
  ['51936448126', '𒀱𝑉𝐼𝐶𝑇𝑂𝑅 シ (ᴄᴏʟᴀʙᴏʀᴀᴅᴏʀ)', true],
]
global.mods = [] 
global.prems = [] 
//╰─────────────────────╯
...
global.ignyc = '\n𝗦𝗵𝗶𝗻𝗮࿐\n𝗦𝗵𝗶𝗻𝗮\n' 
global.wm = '\n𝗦𝗵𝗶𝗻𝗮࿐\n𝗦𝗵𝗶𝗻𝗮\n' 
global.botname = '𝗦𝗵𝗶𝗻𝗮࿐'
global.me = '𝗦𝗵𝗶𝗻𝗮'
//╰─────────────────────╯


//᭥🥗᭢━━━━━━◜𝑻𝑬𝑿𝑻𝑶𝑺◞━━━━━━᭥🥗᭢
global.adimagen = `🌅| Iᴍᴀ́ɢᴇɴᴇs Bʏ 𝗦𝗵𝗶𝗻𝗮🌿` 
global.adanime = `🌸| Aɴɪᴍᴇ Bʏ 𝗦𝗵𝗶𝗻𝗮🈴` 
global.adyoutube = `🍁| Dᴇsᴄᴀʀɢᴀs ᴅᴇ 𝗦𝗵𝗶𝗻𝗮🍄` 
global.adsticker = `🏞️| Sᴛɪᴄᴋᴇʀs Bʏ 𝗦𝗵𝗶𝗻𝗮🌺` 
global.addescargas = `📤| Dᴇsᴄᴀʀɢᴀs Bʏ 𝗦𝗵𝗶𝗻𝗮🌸`
 //╰─────────────────────╯
...
global.estilo = { key: {  fromMe: false, participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "5219992095479-1625305606@g.us" } : {}) }, message: { orderMessage: { itemCount : -999999, status: 1, surface : 1, message: '𝗦𝗵𝗶𝗻𝗮\n𝗦𝗵𝗶𝗻𝗮', orderTitle: 'Bang', thumbnail: catalogo, sellerJid: '0@s.whatsapp.net'}}}
//╰─────────────────────╯
//᭥🌺᭢━━━━◜𝑮𝑰𝑭 𝑽𝑬𝑹𝑰𝑭𝑰𝑪𝑨𝑫𝑶◞━━━━᭥🌺᭢
global.fgif = { key: {participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "6289643739077-1613049930@g.us" } : {})},message: {"videoMessage": { "title":`𝗦𝗵𝗶𝗻𝗮`, "h": `Hmm`,'seconds': '99999', 'gifPlayback': 'true', 'caption': `𝗦𝗵𝗶𝗻𝗮\n𝗦𝗵𝗶𝗻𝗮`, 'jpegThumbnail': imgfgif }}}
//╰─────────────────────╯
//᭥🌺᭢━━━━◜𝑨𝑼𝑫𝑰𝑶 𝑽𝑬𝑹𝑰𝑭𝑰𝑪𝑨𝑫𝑶◞━━━━᭥🌺᭢
...
global.fdocument = {key : {participant : '0@s.whatsapp.net'},message: {documentMessage: {title: `𝗦𝗵𝗶𝗻𝗮࿐\n𝗦𝗵𝗶𝗻𝗮`,jpegThumbnail: catalogo}}}
//╰─────────────────────╯
//᭥🌺᭢━━━◜𝑰𝑴𝑨𝑮𝑬𝑵 𝑽𝑬𝑹𝑰𝑭𝑰𝑪𝑨𝑫𝑨◞━━━᭥🌺᭢
global.fakeimg = { key: {participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "6289643739077-1613049930@g.us" } : {})},message: {"imageMessage": { "title":`𝗦𝗵𝗶𝗻𝗮`, "h": `Hmm`,'seconds': '99999', 'imagePlayback': 'true', 'caption': `𝗦𝗵𝗶𝗻𝗮\n𝗦𝗵𝗶𝗻𝗮`, 'jpegThumbnail': catalogo }}}
//╰─────────────────────╯
//᭥🌺᭢━━━◜𝑴𝑬𝑵𝑺𝑨𝑱𝑬 𝑽𝑬𝑹𝑰𝑭𝑰𝑪𝑨𝑫𝑶◞━━━᭥🌺᭢
global.fakemsg = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "17608914335-1625305606@g.us" } : {}) }, message: { "extendedTextMessage": { "text":'𝗦𝗵𝗶𝗻𝗮࿐\n𝗦𝗵𝗶𝗻𝗮', "title": '𝗦𝗵𝗶𝗻𝗮', 'jpegThumbnail': catalogo}}}
//╰─────────────────────╯
//᭥🌺᭢━◜𝑳𝑶𝑪𝑨𝑳𝑰𝒁𝑨𝑪𝑰𝑶́𝑵 𝑽𝑬𝑹𝑰𝑭𝑰𝑪𝑨𝑫𝑨◞━᭥🌺᭢
global.flocation = {key : {participant : '0@s.whatsapp.net'},message: {locationMessage: {name: `𝗦𝗵𝗶𝗻𝗮࿐\n𝗦𝗵𝗶𝗻𝗮`,jpegThumbnail: catalogo}} }
//╰─────────────────────╯
//᭥🌺᭢━━━◜𝑽𝑰́𝑫𝑬𝑶 𝑽𝑬𝑹𝑰𝑭𝑰𝑪𝑨𝑫𝑶◞━━━᭥🌺᭢
global.fvideo = {key: { fromMe: false,participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "6289643739077-1613049930@g.us" } : {}) },message: { "videoMessage": { "title":`𝗦𝗵𝗶𝗻𝗮`, "h": `Hmm`,'seconds': '2022', 'caption': `𝗦𝗵𝗶𝗻𝗮`, 'jpegThumbnail': catalogo}} }
//╰─────────────────────╯
//᭥🌺᭢━━━◜𝑳𝑰𝑵𝑲𝑮𝑷 𝑽𝑬𝑹𝑰𝑭𝑰𝑪𝑨𝑫𝑶◞━━━᭥🌺᭢
global.fgclink = {key: {participant: "0@s.whatsapp.net","remoteJid": "0@s.whatsapp.net"},"message": {"groupInviteMessage": {"groupJid": "6288213840883-1616169743@g.us","inviteCode": "m","groupName": "Alberto", "caption": `𝗦𝗵𝗶𝗻𝗮࿐\n𝗦𝗵𝗶𝗻𝗮`, 'jpegThumbnail': catalogo}} }
//╰─────────────────────╯
//᭥🌺᭢━━◜𝑷𝑹𝑶𝑫𝑼𝑪𝑻𝑶 𝑽𝑬𝑹𝑰𝑭𝑰𝑪𝑨𝑫𝑶◞━━᭥🌺᭢
global.fproducto = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "17608914335@s.whatsapp.net" } : {}) }, message: { "productMessage": { "product": { "productImage":{ "mimetype": "image/jpeg", "jpegThumbnail": catalogo }, "title": "𝗦𝗵𝗶𝗻𝗮࿐", "description": "SHINA_XD", "currencyCode": "USD", "priceAmount1000": "200000000", "retailerId": "Ghost", "productImageCount": 1 }, "businessOwnerJid": `0@s.whatsapp.net` }}}
//╰─────────────────────╯
//᭥🌺᭢━━━◜𝑳𝑰𝑽𝑬 𝑳𝑶𝑪𝑨𝑳𝑰𝒁𝑨𝑪𝑰𝑶́𝑵◞━━━᭥🌺᭢
global.liveloc = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(false  ? { remoteJid: "status@broadcast" } : {}) }, message: { "liveLocationMessage": { "caption":"𝗦𝗵𝗶𝗻𝗮࿐","h": `𝗦𝗵𝗶𝗻𝗮࿐`, 'jpegThumbnail': catalogo}}}
//╰─────────────────────╯
//᭥🌺᭢━━◜𝑷𝑹𝑶𝑫𝑼𝑪𝑻𝑶 𝑽𝑬𝑹𝑰𝑭𝑰𝑪𝑨𝑫𝑶 2◞━━᭥🌺᭢
global.fproducto2 = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "status@broadcast" } : {})}, message: { "productMessage": { "product": { "productImage":{ "mimetype": "image/jpeg", "jpegThumbnail": catalogo }, "title": `𝗦𝗵𝗶𝗻𝗮࿐`, "retailerId": "𝗦𝗵𝗶𝗻𝗮࿐", "productImageCount": 1 }, "businessOwnerJid": `0@s.whatsapp.net` }}}
//╰─────────────────────╯
//᭥🌺᭢━━◜𝑽𝑰𝑬𝑾𝑶𝑵𝑪𝑬 𝑽𝑬𝑹𝑰𝑭𝑰𝑪𝑨𝑫𝑶◞━━᭥🌺᭢
...
//᭥🌄᭢━━━━━◜𝑨𝑫 𝑫𝑬 𝑮𝑹𝑼𝑷𝑶◞━━━━━᭥🌄᭢
global.adgp = { contextInfo: { externalAdReply: { showAdAttribution: true, title: '𝗦𝗵𝗶𝗻𝗮࿐', body: global.botname, sourceUrl: global.linkgc, thumbnail: miniurl }}}
//╰─────────────────────╯
